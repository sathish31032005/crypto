  ...
  return (
    <Col className="coin-detail-container">
      <Col className="coin-heading-container">
        ...
        <p>
          {cryptoDetails?.name} Live Price & Market Data – USD Value, Supply & Market Cap.
        </p>
      </Col>
      <Select
        defaultValue="5y"
      ...
      <Col className="stats-container">
        <Col className="coin-value-statistics">
          <Col className="coin-value-statistics-heading">
            ...
            <p>A detailed look at the statistics of {cryptoDetails?.name}</p>
          </Col>
        ...
        <Col className="other-stats-info">
          <Col className="coin-value-statistics-heading">
            ...
            <p>A comprehensive overview of all cryptocurrency statistics</p>
          </Col>
